...
public sealed class PageRendererContentTests : RendererTestBase
{
    private static byte[] Page100(string content)
    {
        ...
        offsets.Add(Len());
        Ln("2 0 obj");
        Ln("<< /Type /Pages /Kids [3 0 R] /Count 1 >>");
        Ln("endobj");
        offsets.Add(Len());
        Ln("3 0 obj");
        Ln("<< /Type /Page /Parent 2 0 R /MediaBox [0 0 100 100] /Contents 4 0 R /Resources << >> >>");
        Ln("endobj");
    ...
    private static byte[] ShadingPatternPdf()
    {
        ...
        offsets.Add(Len());
        Ln("3 0 obj");
        Ln("<< /Type /Page /Parent 2 0 R /MediaBox [0 0 100 100] /Contents 4 0 R");
        Ln("   /Resources << /Pattern << /P1 5 0 R >> >> >>");
        Ln("endobj");
        var cb = Encoding.Latin1.GetBytes(content);
        offsets.Add(Len());
        Ln("4 0 obj");
        ...
        offsets.Add(Len());
        Ln("5 0 obj");
        Ln("<< /Type /Pattern /PatternType 2 /Shading");
        Ln("   << /ShadingType 2 /ColorSpace /DeviceRGB /Coords [0 0 100 100] /Domain [0 1]");
        Ln("      /Function << /FunctionType 2 /Domain [0 1] /C0 [1 0 0] /C1 [0 0 1] /N 1 >>");
        Ln("      /Extend [true true] >> >>");
        Ln("endobj");
        var xref = Len();
        Ln("xref");
    ...
    private static byte[] MeshShadingPdf()
    {
        ...
        Ln("3 0 obj");
        Ln("<< /Type /Page /Parent 2 0 R /MediaBox [0 0 100 100] /Contents 4 0 R");
        Ln("   /Resources << /Shading << /Sh1 5 0 R >> >> >>");
        Ln("endobj");
        ...
        offsets.Add(Len());
        Ln("5 0 obj");
        Ln("<< /ShadingType 4 /ColorSpace /DeviceRGB /BitsPerCoordinate 8 /BitsPerComponent 8");
        Ln("   /BitsPerFlag 8 /Decode [0 100 0 100 0 1 0 1 0 1]");
        Ln($"   /Length {mesh.Length} >>");
        sb.Append("stream\n");
    ...
    private static byte[] RadialShadingPdf()
    {
        ...
        offsets.Add(Len());
        Ln("5 0 obj");
        Ln("<< /ShadingType 3 /ColorSpace /DeviceRGB /Coords [50 50 0 50 50 50] /Domain [0 1]");
        Ln("   /Function << /FunctionType 2 /Domain [0 1] /C0 [1 0 0] /C1 [0 0 1] /N 1 >>");
        Ln("   /Extend [true true] >>");
        Ln("endobj");
        var xref = Len();
