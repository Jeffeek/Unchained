...
public sealed class LookupFunctionTests
{
    ...
    {
        var result = Num("=VLOOKUP(\"B\",A2:B3,2,FALSE)", sheet =>
        {
    ...
    {
        var result = Text("=VLOOKUP(60,A1:B3,2,TRUE)", sheet =>
        {
    ...
    {
        var result = Eval("=VLOOKUP(\"Z\",A1:B2,2,FALSE)", sheet =>
        {
    ...
    {
        var result = Eval("=VLOOKUP(\"A\",A1:B1,5,FALSE)", sheet =>
        {
            sheet.SetValue(1, 1, "A");
            sheet.SetValue(1, 2, 1);
        });
    ...
    {
        var result = Eval("=VLOOKUP(\"A\",A1,2,FALSE)", sheet =>
        {
            sheet.SetValue(1, 1, "A");
        });
    ...
    {
        var result = Num("=HLOOKUP(\"B\",A1:C2,2,FALSE)", sheet =>
        {
            sheet.SetValue(1, 1, "A");
    ...
    {
        var result = Eval("=HLOOKUP(\"Z\",A1:B2,2,FALSE)", sheet =>
        {
            sheet.SetValue(1, 1, "A");
            sheet.SetValue(1, 2, "B");
    ...
    {
        var result = Num("=INDEX(A1:C1,2)", sheet =>
        {
            sheet.SetValue(1, 1, 10);
    ...
    {
        var result = Num("=INDEX(A1:A3,2)", sheet =>
        {
            sheet.SetValue(1, 1, 10);
    ...
    {
        var result = Num("=INDEX(A1:B2,2,1)", sheet =>
        {
    ...
    {
        var result = Eval("=INDEX(A1:A2,5)", sheet =>
        {
            sheet.SetValue(1, 1, 10);
            sheet.SetValue(2, 1, 20);
        });
    ...
    {
        var result = Eval("=INDEX(A1:B2,0,1)", sheet =>
        {
            sheet.SetValue(1, 1, 1);
            sheet.SetValue(1, 2, 2);
        });
    ...
    {
        var result = Num("=MATCH(\"Banana\",A1:A3,0)", sheet =>
        {
    ...
    {
        var result = Num("=MATCH(25,A1:A3,1)", sheet =>
        {
            sheet.SetValue(1, 1, 10);
            sheet.SetValue(2, 1, 20);
            sheet.SetValue(3, 1, 30);
    ...
    {
        var result = Num("=MATCH(15,A1:A3,-1)", sheet =>
        {
    ...
    {
        var result = Eval("=MATCH(\"Z\",A1:A2,0)", sheet =>
        {
            sheet.SetValue(1, 1, "A");
            sheet.SetValue(2, 1, "B");
        });
    ...
    public void Match_DefaultMatchType_UsesApproximate()
    {
        ...
        var result = Num("=MATCH(25,A1:A3)", sheet =>
        {
            sheet.SetValue(1, 1, 10);
            sheet.SetValue(2, 1, 20);
            sheet.SetValue(3, 1, 30);
    ...
    {
        var result = Eval("=MATCH(5,A1:A3,1)", sheet =>
        {
            sheet.SetValue(1, 1, 10);
            sheet.SetValue(2, 1, 20);
            sheet.SetValue(3, 1, 30);
    ...
    {
        var result = Eval("=MATCH(50,A1:A3,-1)", sheet =>
        {
            sheet.SetValue(1, 1, 30);
            sheet.SetValue(2, 1, 20);
            sheet.SetValue(3, 1, 10);
    ...
    public void Index_NonArrayScalar_ReturnsScalar()
    {
        ...
        var result = Num("=INDEX(A1,1)", sheet =>
        {
