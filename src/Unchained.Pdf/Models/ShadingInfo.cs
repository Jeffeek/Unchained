...
/// <param name="R0">Vertex 0 red (0–255).</param>
/// <param name="G0">Vertex 0 green.</param>
/// <param name="B0">Vertex 0 blue.</param>
/// <param name="X1">Vertex 1 X.</param>
/// <param name="Y1">Vertex 1 Y.</param>
/// <param name="R1">Vertex 1 red.</param>
/// <param name="G1">Vertex 1 green.</param>
/// <param name="B1">Vertex 1 blue.</param>
/// <param name="X2">Vertex 2 X.</param>
/// <param name="Y2">Vertex 2 Y.</param>
/// <param name="R2">Vertex 2 red.</param>
/// <param name="G2">Vertex 2 green.</param>
/// <param name="B2">Vertex 2 blue.</param>
