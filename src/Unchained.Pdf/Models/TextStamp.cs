...
/// <param name="FontName">Base font name (Standard 14 only for M4). Default: <c>Helvetica</c>.</param>
...
/// <param name="IsBackground">When <see langword="true"/>, the stamp is prepended to <c>/Contents</c> so it appears
