...
public static class FilePicker
{
    ...
    public static Task<(byte[] Bytes, string ContentType, string Name)?> PickImageAsync() =>
        Task.FromResult<(byte[] Bytes, string ContentType, string Name)?>(null); // Simplified — will use inline approach in playboard instead.
}
